...
<section id="content" class="main-content">
  ...
  ?>
    <div class="row clearfix ">
          <div class="span3"></div>
			<div class="span12">
				<h2>Bar Details <a href="business_owner_edit_profile.php" class="pink pull-right"><i class="fa fa-pencil-square-o  fa-2x" aria-hidden="true"></i></a></h2>
					...
					<form id="profile" class="form-horizontal">
						...
						<div class="span6 pull-right">
							...
							<div class="control-group">
								...
								<span><?php echo (@$barDetails[0]['is_hall_available']==1)?"Available ( Capacity of ".@$barDetails[0]['hall_capacity']." people)":"Not available"; ?></span>
							</div>
							<br>
