...
if ($id == "") {
    ...
    <section id="content" class="main-content">
        <div class="container" id="events_container">
            <div class="row ">
                <div class="clearfix ">
                    <div class="span12">
                        <h5>You are not Logged in yet. Please <a href="business_owner_signin.php"
                                                                 style="color:#3179d8;">login </a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <head>
        ...
        <style>
            ...
            body {
                ...
                line-height: 20px;
                color: #9393a7;
                background: #16151f url(../images/bg_top.jpg) 50% top repeat-x;
            }
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <?php if ($isOptOutUser != 1) { ?>
                    ...
                    <li <?php if ($page_name == '') { ?> class="active" <?php } ?>><a href="<?php SITE_PATH; ?>/"><i
                                    class="fa fa-home " aria-hidden="true"></i>Home</a></li>
                    <li <?php if ($page_name == 'manage_bar_profile.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/manage_bar_profile.php"><i class="fa fa-beer" aria-hidden="true"></i>Bar Listing</a></li>
                    <li <?php if ($page_name == 'business_owner_gallary.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_owner_gallary.php"><i
                                    class="fa fa-picture-o" aria-hidden="true"></i>Gallery</a></li>
                    <li <?php if ($page_name == 'business_owner_foodmenu.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_owner_foodmenu.php"><i
                                    class="fa fa-bars" aria-hidden="true"></i>Food Menu</a></li>
                    <li <?php if ($page_name == 'business_owner_subscription.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_owner_subscription.php"><i
                                    class="fa fa-usd" aria-hidden="true"></i>Subscription</a></li>
                    <li <?php if ($page_name == 'business_owner_account.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_owner_account.php"><i
                                    class="fa fa-user-circle"></i>Account</a></li>
                    <li <?php if ($page_name == 'myblogs.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/myblogs.php"><i class="fa fa-rss-square"></i>My
                            Blog</a></li>
                    <li <?php if ($page_name == 'business_user_guide.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_user_guide.php"><i
                                    class="fa fa-list-alt" aria-hidden="true"></i>User Guide</a></li>
                    <li <?php if ($page_name == 'business_owner_settings.php') { ?> class="active" <?php } ?>><a
                                href="<?php SITE_PATH; ?>/business_owner/business_owner_settings.php"><i
                                    class="fa fa-cog" aria-hidden="true"></i>Manage Profile/Staff</a></li>
                <?php } else { ?>
                    <li><a href="#" id="deleteAccount"><i class="fa fa-user-times" aria-hidden="true"></i>Delete Account</a>
                    </li>
                <?php }
                if (isset($_SESSION['business_owner_id']) || sset($_SESSION['subUserId'])) {
                    ?>
                    <li><a href="<?php SITE_PATH; ?>/business_owner/logout.php"><i class="fa fa-sign-out"
        ...
        <div id="content" class="container">
            ...
            <div class="col-md-12">
                <h2 class="align-center">Welcome to Admin Panel <?php echo $businessName; ?></h2>
            </div>
            <div class="col-md-10">
                <div id="errMsg"></div>
            </div>
            <?php if ($isOptOutUser != 1) { ?>
                <div class="col-md-12">
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/business_owner_events.php"
                                    class="btn btn-color">Manage Events</a></h2>
                        <span class=""><i class="fa fa-calendar fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">

                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/business_owner_promotions.php"
                                    class="btn btn-color">Manage Promotions</a></h2>
                        <span class=""><i class="fa fa-gift fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        ...
                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/manage_bar_profile.php"
                                    class="btn btn-color">Manage Venue</a></h2>
                        <span class=""><i class="fa fa-map-marker fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        ...
                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/business_owner_sales.php"
                                    class="btn btn-color">Sales</a></h2>
                        <span class=""><i class="fa fa-pie-chart fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/business_owner_orders.php"
                                    class="btn btn-color">Orders</a></h2>
                        <span class=""><i class="fa fa-file-text fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a
                                    href="https://mybarnite.com/business_owner/business_owner_subscription.php"
                                    class="btn btn-color" style="padding:6px 4px;">Manage Subscription</a></h2>
                        <span class=""><i class="fa fa-usd fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>
                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a href="https://mybarnite.com/business_owner/billing_cycles.php"
                                                                   class="btn btn-color">View Bill Cycles</a></h2>
                        <span class=""><i class="fa fa-spinner fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>

                    <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a href="https://mybarnite.com/business_owner/business_owner_account.php"
                                                                   class="btn btn-color">Account</a></h2>
                        <span class=""><i class="fa fa-user fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div>

                    <!-- <div class="col-md-3 align-center" style="background:#15161f;padding:4%;margin:0 3px 3px 0;">
                        <h2 style="text-transform: capitalize;"><a href="https://mybarnite.com/business_owner/business_owner_gallary.php"
                                                                   class="btn btn-color">Gallery</a></h2>
                        <span class=""><i class="fa fa-image fa-5x calendar-bg-pink"
                                          style="padding-top: 11%;color: #E4287C;"
                                          aria-hidden="true"></i></span>
                    </div> -->
                ...
                <form id="ajax-contact-form" class="form-horizontal edit_profile" method="post">
                    ...
                    <div class="form-check">
                        <label class="form-check-label" for="checkbox100">Opt-in:
                            <input type="radio" name="radiobtn" class="form-check-input pull-left" id="checkbox100"
                                   value="0" <?php if ($isOptOutUser == 0) {
                                echo "checked";
                            } ?>>
                            I have read and agreed to Mybarnite Limited <a target="_blank" style="color:#3179d8;"
                                                                           href="<?php echo SITE_PATH; ?>/terms.php">Terms
                                and Conditions</a> & <a target="_blank" style="color:#3179d8;"
                                                        href="<?php echo SITE_PATH; ?>/policy.php">Privacy
                                Policy</a></label>
                    </div>

                    <div class="form-check">
                        <label class="form-check-label" for="checkbox100">Opt-Out:
                            <input type="radio" name="radiobtn" class="filled-in form-check-input pull-left"
                                   id="checkbox101" value="1" <?php if ($isOptOutUser == 1) {
                                echo "checked";
                            } ?>>
                            We may contact you about products and services, unless you select Opt-Out from the <a
                                    target="_blank" style="color:#3179d8;"
                                    href="<?php echo SITE_PATH; ?>/terms.php">Terms
                                and Conditions</a> & <a target="_blank" style="color:#3179d8;"
                                                        href="<?php echo SITE_PATH; ?>/policy.php">Privacy
                                Policy</a></label>
    ...
    <script>
        ...
        function popUpWarningMessage(isOptInOut, userId) {
            var rId = <?php echo (isset($_SESSION['subUserId'])) ? '3' : '1';?>;
            if (isOptInOut == 1) {
