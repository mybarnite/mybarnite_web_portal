    	...
    	<div class="row">
        	...
        	<div class="span4 top_right">
				...
				?>
						...
						<a style="color:Black; font-size:15px;" class="on_air"><?php echo substr($_SESSION['business_owner_name'],0,10); ?></a>
				...
				?>
					<a href="logout.php" style="font-size:15px;" class="listen_live">LOGOUT</a>
					<a style="color:Black; font-size:15px;" class="on_air"><?php echo substr($_SESSION['subUserName'],0,10); ?></a>
				<?php
				}else{
							...
							<div class="container">
								...
								<div class="nav-collapse nav-collapse_ collapse">
									...
									<?php /*	<li <?php if($page_name=='index.php'){?> class="active" <?php }?>><a href="<?php echo SITE_PATH;?>">Home</a></li> */?>
										...
										<?php/*
										<li>
											<a href="#a" class="sf-with-ul">Dashboard</a>
									...
									?>
									<ul class="nav sf-menu">
										<li <?php if($page_name=='subuser_dashboard.php'){?> class="active" <?php }?>><a href="<?php echo SITE_PATH;?>business_owner/subuser_dashboard.php">Dashboard</a></li>
										<li <?php if($page_name=='business_owner_settings.php'){?> class="active" <?php }?>><a href="<?php echo SITE_PATH;?>business_owner/business_owner_settings.php">Edit profile</a></li>
									</ul>	
									<?php		
									}
									?>
