...
class business_owner{
	...
	private $db_user = "barnite";  // Change as required
	private $db_pass = "Infoms321";  // Change as required
	private $db_name = "barnite";	// Change as required
    ...
    // Function to update column value with othe column value in database
    public function update_calculation($table,$params=array(),$where){
    	// Check to see if table exists
    	if($this->tableExists($table)){
    		// Create Array to hold all the columns to update
            $args=array();
