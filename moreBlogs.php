...
$sql1 = "SELECT COUNT(*) as num_rows FROM tbl_manage_blogs WHERE status = 'Active' and created_at < '".$created_at."' ORDER BY created_at DESC";
...
$sql = "SELECT * from tbl_manage_blogs where status = 'Active' and created_at < '".$created_at."' ORDER BY created_at DESC LIMIT ".$showLimit;
