  ...
  <div class="container">
    <div class="row clearfix ">
		...
		<div class="span6">
			...
			<?php
					$showdataquery = mysql_query(" SELECT * FROM user_register WHERE id='".$_SESSION['isLoggedIn']."' ") or die(mysql_error());
			...
			<?php } ?>
      			...
      			<div id="fields" class="contact-form">
      				<form id="ajax-contact-form" class="form-horizontal">
      					...
      					<span style="font-size:16px;"><?php echo $showdatarow['id']; ?></span>
      					</div>
					<br/>
      					<div class="control-group">
