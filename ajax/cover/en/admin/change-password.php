...
if(isset($_REQUEST['submitBtn']))
{
	...
	{
		mysql_query("UPDATE admin_login SET password = '$NewPass' WHERE password = '$OldPass'");
	}
}
?>
...
<div class="wrapper">
    ...
    <!-- Content -->
    <div class="content">
    	<div class="title"><h5>Site Management</h5></div>
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="formRight"><input name="oldpass" type="password" id="oldpass" /></div><div class="fix"></div></div>
            <div class="rowElem">
            <label>NEW Password:</label>
            <div class="formRight"><input name="newpass" type="password" id="newpass" /></div><div class="fix"></div></div>
