...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Manage Contacts</h5>
       	  </div>
        <div style="text-align:right; padding:6px;"><a href="add-contact.php">Add Contact</a></div>
      	<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="34%" align="left" valign="middle" style="padding-left:8px; text-align:left;">Full Name</td>
                        <td width="32%" align="center" valign="middle">Email</td>
                        <td width="20%" align="center" valign="middle">Phone No.</td>
                        <td width="14%">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php $getQuery = mysql_query("SELECT * FROM `addressbook` ORDER BY id DESC");
					  while($getValue = mysql_fetch_array($getQuery)) { ?>
                	<tr>
                        <td width="34%"><?php echo $getValue['fullname']; ?></td>
                        <td width="32%" align="center" valign="middle"><?php echo $getValue['email']; ?></td>
                        <td width="20%" align="center" valign="middle"><?php echo $getValue['phone']; ?></td>
                        <td width="14%" align="center"><a href="add-contact.php?eID=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to edit the contact information?')">Edit</a>&nbsp;&nbsp;<span style="color:#CCC;">|</span>&nbsp;&nbsp;<a href="manage-contact.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
