...
{
	mysql_query("DELETE FROM admin_group WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
       	  <div class="head">
        	  <h5 class="iFrames">Manage Group</h5>
       	  </div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td align="left" valign="middle" style="text-align:left; padding-left:8px;">Group Name</td>
                        <td width="20%">Action</td>
                  </tr>
                </thead>
                <tbody>
                <?php $getQuery = mysql_query("SELECT * FROM admin_group ORDER BY group_name");
				while($getValue = mysql_fetch_array($getQuery)) { ?>
                	<tr>
                        <td align="left" valign="middle"><?php echo $getValue['group_name'];?></td>
                        <td width="20%" align="center"><a href="edit-group.php?eID=<?php echo $getValue['id']; ?>">Edit</a> / <a href="manage-category.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  </tr>
                    <?php } ?>
                </tbody>
            </table>
