...
<div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="widget first">
       	<div class="head"><h5 class="iFrames">New Label Request</h5></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
              ...
              <tbody>
                <?php $getQuery = mysql_query("SELECT * FROM labels WHERE status = 'N' ORDER by datetime DESC");
                    ...
                    <td width="14%" align="center" valign="middle"><?php if($getValue['status'] == 'Y') { ?><a href="designerLabels.php?label=<?php echo $getValue['id']; ?>&status=N" style="color:#090;">Approve</a><?php } else { ?><a href="designerLabels.php?label=<?php echo $getValue['id']; ?>&status=Y" style="color:#F00;">Hold</a><?php } ?></td>
