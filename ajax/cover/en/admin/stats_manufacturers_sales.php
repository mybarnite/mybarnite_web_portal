...
<div class="wrapper">
    ...
    <div style="padding:18px 0 0 0;">This report displays which manufacturers sold products within a given date range. Each line is a link to a breakdown of the products for that manufacturer.</div>
    <div style="padding:6px 0 0 0;">
      <form id="form1" name="form1" method="post" action="">
        ...
        <div class="widget first">
       	  <div class="head"><h5 class="iFrames">Seller/Vendor Sales</h5></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <tbody>
					...
					$getPage = mysql_query("SELECT * FROM transaction WHERE date >= '".date("d M, Y")."' AND date <= '".date("d M, Y")."'");	
                        ...
                        {
							$getproRecord = mysql_fetch_array(mysql_query("SELECT * FROM products WHERE proid = '".$getArray['proid']."'"));
                    ?>
                    <tr>
                        ...
                        <td width="15%" align="center"><?php $userName =  mysql_fetch_array(mysql_query("SELECT * FROM manufacturers WHERE id = '".$getproRecord['manufacturer']."'")); echo $userName['manufacturer']; ?></td>
