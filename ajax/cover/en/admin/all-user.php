...
if(isset($_REQUEST['DelId'])!='')
{
	...
	header("location:all-user.php"); exit;
}
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">All Buyers</h5></div>
        	  ...
        	  <tbody>
        	    ...
        	    <tr>
        	      ...
        	      <td align="center"><table width="60%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="center" valign="middle"><?php if($getValue['eVerify'] == 'Y') { ?><a href="all-user.php?activate=<?php echo $getValue['id']; ?>&update=N"><img src="images/email-verify.png" alt="" width="24" title="Email Verified" /></a><?php } else { ?><a href="all-user.php?activate=<?php echo $getValue['id']; ?>&update=Y"><img src="images/email-not-verify.png" width="24" alt="" title="Email Not-Verified" /></a><?php } ?></td>
                            <td align="center" valign="middle"><?php if($getValue['mVerify'] == 'Y') { ?><a href="all-user.php?mValidate=<?php echo $getValue['id']; ?>&update=N"><img src="images/phone-verify.png" alt="" width="24" title="Phone Verified" /></a><?php } else { ?><a href="all-user.php?mValidate=<?php echo $getValue['id']; ?>&update=Y"><img src="images/phone-not-verify.png" width="24" alt="" title="Phone Not-Verified" /></a><?php } ?></td>
                            <td align="center" valign="middle"><a href="all-user.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')"><img src="images/1338632825_trash_16x16.gif" alt="" /></a></td>
                          </tr>
                      </table></td>
