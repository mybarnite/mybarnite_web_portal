...
{
	mysql_query("UPDATE `manufacturers` SET manufacturer = '".$_REQUEST['manufacturer']."', men = '".$_REQUEST['men']."', women = '".$_REQUEST['women']."', baby_boy = '".$_REQUEST['baby_boy']."', baby_girl = '".$_REQUEST['baby_girl']."', boy = '".$_REQUEST['boy']."', girl = '".$_REQUEST['girl']."' WHERE id = '".$_REQUEST['eID']."'");
	header("location:edit-manufacturers.php?eID=".$_REQUEST['eID']."&ret=1");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Edit Brand</h5></div>
            <?php if(isset($_REQUEST['ret']) == '1') { ?>
            	<div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Brand Name Updated Successfully!</div>
            <?php } ?>
            <div class="rowElem noborder">
            <?php $getCat = mysql_fetch_array(mysql_query("SELECT * FROM `manufacturers` where id = '".$_REQUEST['eID']."'")); ?>
            <label>Manufacture</label>
          	<div class="formRight"><input name="manufacturer" type="text" value="<?php echo $getCat['manufacturer']; ?>" /></div>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="33%" height="30">
                  	<input type="checkbox" name="men" <?php if($getCat['men'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Men</td>
                  <td width="33%" height="30"><input type="checkbox" name="women" <?php if($getCat['women'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Women</td>
                  <td width="33%" height="30"><input type="checkbox" name="baby_boy" <?php if($getCat['baby_boy'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Baby Boy (0-2)</td>
                </tr>
                <tr>
                  <td width="33%" height="30"><input type="checkbox" name="baby_girl" <?php if($getCat['baby_girl'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Baby Girl (0-2)</td>
                  <td width="33%" height="30"><input type="checkbox" name="boy" <?php if($getCat['boy'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Boy (2-12)</td>
                  <td width="33%" height="30"><input type="checkbox" name="girl" <?php if($getCat['girl'] == 'Y') { ?> checked="checked" <?php } ?> value="Y" />&nbsp;&nbsp;Girl (2-12)</td>
                </tr>
              </table>
