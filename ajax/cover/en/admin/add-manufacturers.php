...
if(isset($_REQUEST['submit']) && $_REQUEST['cityname'] != ''){
    $exist = false;
    $getQuery = mysql_query("SELECT * FROM `manufacturers` ORDER BY manufacturer");
     while($getValue = mysql_fetch_array($getQuery)) { 
        if(strtolower($getValue['manufacturer'])==strtolower($_REQUEST['cityname'])){
            $exist = true;
        }
     }
     if(!$exist){
	  $res = mysql_query("INSERT INTO `manufacturers` (`id`, `manufacturer`, `men`, `women`, `baby_boy`, `baby_girl`, `boy`, `girl`, `status`) VALUES ('', '".$_REQUEST['cityname']."', '".$_REQUEST['men']."', '".$_REQUEST['women']."', '".$_REQUEST['baby_boy']."', '".$_REQUEST['baby_girl']."', '".$_REQUEST['boy']."', '".$_REQUEST['girl']."', 'Y')"); header("location:manage-manufacturers.php?ret=1"); exit;
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Add Brand</h5></div>

			<?php if(isset($_REQUEST['ret']) == '1') { ?>

            	<div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Brand Name Added Successfully!</div>
            ...
            <div class="formRight"><input name="cityname" type="text" /></div><div class="fix"></div></div>
            ...
            <div class="formRight">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <td width="33%" height="30"><input type="checkbox" name="men" value="Y" />&nbsp;&nbsp;Men</td>

                  <td width="33%" height="30"><input type="checkbox" name="women" value="Y" />&nbsp;&nbsp;Women</td>

                  <td width="33%" height="30"><input type="checkbox" name="baby_boy" value="Y" />&nbsp;&nbsp;Baby Boy (0-2)</td>

                </tr>

                <tr>

                  <td width="33%" height="30"><input type="checkbox" name="baby_girl" value="Y" />&nbsp;&nbsp;Baby Girl (0-2)</td>

                  <td width="33%" height="30"><input type="checkbox" name="boy" value="Y" />&nbsp;&nbsp;Boy (2-12)</td>

                  <td width="33%" height="30"><input type="checkbox" name="girl" value="Y" />&nbsp;&nbsp;Girl (2-12)</td>
