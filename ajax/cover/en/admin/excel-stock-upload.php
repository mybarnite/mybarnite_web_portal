...
<title>basicfeet.com - Admin Control Panel</title>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Excel Stock Upload</h5></div>
            <div style="font-weight:bold; padding:10px 10px 5px 10px;">Browse and upload .xls, .xlsx file. Please use sample file provided by the development team for correct inputs. Wrong inputs or fields may show wrong informations in the site results.</div>
            <div style="font-weight:bold; padding:5px 10px 20px 10px;">
              
              <input type="file" name="fileField" id="fileField" />
              <input type="submit" name="button" id="button" value="Upload .xls file" onclick="return confirm('Feature Unavailable. Technical Team will discuss with owner about this option.')" />
...
<div id="footer">
	<div class="wrapper">
    	<span>&copy; Copyright <?php echo date("Y"); ?>. All rights reserved. Developed by <a href="http://www.webmantratech.com" title="WebMantra">WebMantra Technologies (India) Pvt Ltd.</a></span>
    </div>
</div>
