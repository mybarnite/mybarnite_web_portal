...
{
	mysql_query("DELETE FROM subcat WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Manage Sub Category</h5>
       	  </div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td colspan="2" align="left" valign="middle" style="text-align:left; padding-left:8px;">Category Name</td>
                        <td width="40%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Sub Category</td>
                        <td width="20%">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php
				$getQuery = mysql_query("SELECT * FROM subcat ORDER BY id ASC");
				while($getValue = mysql_fetch_array($getQuery))
				{
					$getCatName = mysql_fetch_array(mysql_query("SELECT * FROM category WHERE id = '".$getValue['catid']."'"));
				?>
                	<tr>
                        <td colspan="2" align="left" valign="middle"><?php echo $getCatName['catname']; ?></td>
                      	<td><?php echo $getValue['subcat'];?></td>
                        <td width="20%" align="center"><a href="edit-sub-category.php?eID=<?php echo $getValue['id']; ?>">Edit</a> / <a href="manage-sub-category.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                    <?php
				}
				?>
