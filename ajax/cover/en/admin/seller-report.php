...
function popitup(url) {
	newwindow=window.open(url,'name','height=650,width=700');
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Seller Cancellations</h5></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
              <thead>
                <tr>
                  <td width="61%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Seller Details</td>
                  <td width="21%" align="center" valign="middle">Date / Time</td>
                  <td width="18%" align="center" valign="middle">Action</td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td width="61%" align="left" valign="middle" style="text-align:left; padding-left:8px;"><strong>Khadims</strong> - 8961311235</td>
                  <td width="21%" align="center" valign="middle"><strong>Total Reports</strong> 1</td>
                  <td width="18%" align="center" valign="middle"><a href="invoice.php?uid=1" onclick="return popitup('invoice.php?uid=1')">Generate Report</a></td>
                </tr>
              </tbody>
          </table>
        </div>
