...
{
	$updateData = mysql_query("UPDATE featured_story SET featured = 'N'");	
	$update = mysql_query("UPDATE featured_story SET story = '".$_REQUEST['story']."', featured = '".$_REQUEST['radio']."' WHERE id = '".$_REQUEST['eID']."'");
	header("location:edit-story.php?eID=".$_REQUEST['eID']."");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <!-- Static table -->
        <?php $getStory = mysql_fetch_array(mysql_query("SELECT * FROM featured_story WHERE id = '".$_REQUEST['eID']."'")); ?>
        <?php $getProj = mysql_fetch_array(mysql_query("SELECT * FROM mypitch WHERE id = '".$getStory['pid']."'")); ?>
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="formRight"><strong><?php echo $getProj['title']; ?></strong></div><div class="fix"></div></div>
            <div class="rowElem noborder">
            <label>Story</label>
            <div class="formRight"><textarea name="story" cols="" rows="6" id="story"><?php echo $getStory['story']; ?></textarea></div><div class="fix"></div></div>
            <div class="rowElem noborder">
            <label>Featured</label>
            <div class="formRight">
              <table width="200" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="25%" align="left" valign="middle"><input type="radio" name="radio" id="radio" value="Y" /></td>
                  <td height="25%" align="left" valign="middle">Featured</td>
                  <td height="25%" align="left" valign="middle"><input type="radio" name="radio" id="radio2" value="N" /></td>
                  <td height="25%" align="left" valign="middle">General</td>
                </tr>
              </table>
