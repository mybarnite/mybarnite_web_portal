...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div style="text-align:right; padding:6px;"><a href="add-coupons.php">Add Coupons</a></div>
      	<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="41%" align="left" valign="middle" style="padding-left:8px; text-align:left;">Offer Name</td>
                        <td width="0%" align="center" valign="middle">Promo Code</td>
                        <td width="0%" align="center" valign="middle">Discount</td>
                        <td width="30%" align="center" valign="middle">Expiry Date</td>
