...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div style="padding:18px 0 0 0;">This report displays products viewed most in descending order; the largest total listed first. This list also shows you which category each product is in and the name is a link to that specific product.</div>
        <!-- Static table -->
        <div class="widget first">
       	  <div class="head"><h5 class="iFrames">Products Viewed</h5></div>
            	...
            	<thead>
                	<tr>
                      <td width="60%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Search Keyword</td>
                        ...
                        <td width="20%">Last Searched</td>
                    </tr>
                </thead>
                <tbody>
				<?php
                $getPage = mysql_query("SELECT * FROM product_view ORDER by count DESC");
                	while($getArray = mysql_fetch_array($getPage))
                	{
                ?>
                    <tr>
                        <td width="60%" align="left" valign="middle"><?php $getProducts = mysql_fetch_array(mysql_query("SELECT * FROM products WHERE proid = '".$getArray['productid']."' ")); echo $getProducts['product_name']; ?></td>
                        <td width="20%" align="center"><?php echo $getArray['count']; ?></td>
                        <td width="20%" align="center"><?php echo $getArray['datetime']; ?></td>
                    </tr>
                <?php
                	}
                ?>
