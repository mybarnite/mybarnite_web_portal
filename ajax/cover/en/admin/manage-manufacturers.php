...

{
	...
	mysql_query("DELETE FROM `manufacturers` WHERE id = '".$_REQUEST['DelId']."' ");
...
<div id="header" class="wrapper">
    ...
    <div class="logo">
    <?php $getlogo = mysql_fetch_array(mysql_query("SELECT * FROM `website_settings` WHERE id = '1'")); ?><a href="index.php"><img src="../upload/logo/<?php echo $getlogo['site_logo']; ?>" alt="" border="0" /></a></div>
    ...
    <div class="content">
        ...
        <div class="widget first">
        	...
        	<div class="head">
        	  ...
        	  <h5 class="iFrames">Manage Brand(s)</h5>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	...
            	<thead>
                	...
                	<tr>
                        ...
                        <td style="text-align:left; padding-left:8px;">Manufacture Name</td>
                ...
                <?php $getQuery = mysql_query("SELECT * FROM `manufacturers` ORDER BY manufacturer");

					  while($getValue = mysql_fetch_array($getQuery)) { ?>

                	<tr>

                        <td><?php echo $getValue['manufacturer'];?></td>

                        <td width="20%" align="center"><a href="edit-manufacturers.php?eID=<?php echo $getValue['id']; ?>">Edit</a> / <a href="manage-manufacturers.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
