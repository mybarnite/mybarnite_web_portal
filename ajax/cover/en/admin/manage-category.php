...
if(isset($_REQUEST['categ'])){
   ...
   /* $exist = false;
     ...
     //if(!$exist){
        $res = mysql_query("INSERT INTO `category` (`uid`, `catname`, `status`) VALUES ('0', '".$_REQUEST['category_name']."', 'Y')");
     //}
    ...
    <div class="content">
        ...
        <div class="widget first">
        	...
        	<div class="head">
        	  ...
        	  <h5 class="iFrames">Manage Category</h5>
          ...
          <div style="padding:5px 10px;">
                <form id="form1" name="form1" method="post" action="">
                  ...
                  <input type="text" name="category_name" id="textfield" style="padding:5px;" placeholder="Enter Category Name" />

                  <input type="submit" name="categ" id="button" value="Add New Category" />
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	...
            	<thead>
                	...
                	<tr>
                        ...
                        <td style="padding-left:10px; text-align:left;">Category Name</td>
                ...
                <?php $getQuery = mysql_query("SELECT * FROM category ORDER BY catname");

				while($getValue = mysql_fetch_array($getQuery)) { ?>

                	<tr>

                        <td><?php echo $getValue['catname'];?></td>

                        <td width="20%" align="center"><a href="edit-category.php?eID=<?php echo $getValue['id']; ?>">Edit</a> / <a href="manage-category.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
