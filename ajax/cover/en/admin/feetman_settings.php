...

{
	...
	mysql_query("UPDATE `website_settings` SET suggestion_one = '".mysql_real_escape_string($_REQUEST['suggestion_one'])."', suggestion_two = '".mysql_real_escape_string($_REQUEST['suggestion_two'])."', suggestion_three = '".mysql_real_escape_string($_REQUEST['suggestion_three'])."' WHERE id = '1'"); header("location:feetman_settings.php?ret=1"); exit();
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Feetman Settings</h5></div>

			<?php if(isset($_REQUEST['ret']) == '1') { ?>

            <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Feetman suggestion updated successfully!</div>
            ...
            <div class="formRight">
              ...
              <textarea name="suggestion_one"><?php echo $getsettings['suggestion_one']; ?></textarea></div></div>
            ...
            <textarea name="suggestion_two"><?php echo $getsettings['suggestion_two']; ?></textarea></div></div>
           ...
           <textarea name="suggestion_three"><?php echo $getsettings['suggestion_three']; ?></textarea></div><div class="fix"></div></div>
