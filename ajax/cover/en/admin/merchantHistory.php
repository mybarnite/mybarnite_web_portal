...
if(isset($_REQUEST['DelId'])!='')
{
	...
	header("location:merchantHistory.php");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Seller History</h5></div>
            
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="61%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Order Details</td>
                      <td width="21%">Placed On</td>
                      <td width="18%">Action</td>
                    </tr>
                </thead>
                <tbody>
                	<tr>
                      <td height="100" colspan="3" align="center" valign="middle">No Result Found.</td>
                    </tr>
                </tbody>
            </table>
