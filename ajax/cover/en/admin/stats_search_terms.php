...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div style="padding:18px 0 0 0;">This report displays the top 100 most searched terms from the site search.</div>
        <!-- Static table -->
        <div class="widget first">
       	  <div class="head"><h5 class="iFrames">Top Search Terms</h5></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <tbody>
				<?php
                $getPage = mysql_query("SELECT * FROM search ORDER by count DESC");
                	while($getArray = mysql_fetch_array($getPage))
                	{
                ?>
                    <tr>
                        <td width="60%" align="left" valign="middle"><?php echo $getArray['keyword']; ?></td>
