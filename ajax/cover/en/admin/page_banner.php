...
if(isset($_REQUEST['submit']))
{
	...
	mysql_query("UPDATE `website_settings` SET banner_one = '".$FileName1."', banner_two = '".$FileName2."', banner_three = '".$FileName3."', banner_one_url = '".$_REQUEST['banner_one_url']."', banner_two_url = '".$_REQUEST['banner_two_url']."', banner_three_url = '".$_REQUEST['banner_three_url']."' WHERE id = '1'"); 
	header("location:page_banner.php?ret=1"); exit();
}
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" method="post" enctype="multipart/form-data" name="form1" class="mainForm" id="form1">
            ...
            <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;"> Details Page Updated Successfully!</div>
            <?php } ?>
            <div class="rowElem noborder">
            <label>Banner 1</label>
            <div class="formRight">
              <input type="file" name="ufile1" id="fileField" />
              <img src="../upload/shopBanner/<?php echo $getInformation['banner_one']; ?>" width="260" alt="" />
              <input type="text" name="banner_one_url" placeholder="Wesbsite URL" value="<?php echo $getInformation['banner_one_url']; ?>" />
            </div></div>
            <div class="rowElem noborder">
            <label>Banner 2</label>
            <div class="formRight">
              <input type="file" name="ufile2" id="fileField2" />
              <img src="../upload/shopBanner/<?php echo $getInformation['banner_two']; ?>" width="260" alt="" />
              <input type="text" name="banner_two_url" placeholder="Wesbsite URL" value="<?php echo $getInformation['banner_two_url']; ?>" />
            </div></div>
            <div class="rowElem noborder">
            <label>Banner 3</label>
            <div class="formRight">
              <input type="file" name="ufile3" id="fileField3" />
              <img src="../upload/shopBanner/<?php echo $getInformation['banner_three']; ?>" width="260" alt="" />
           	  <input type="text" name="banner_three_url" placeholder="Wesbsite URL" value="<?php echo $getInformation['banner_three_url']; ?>" />
