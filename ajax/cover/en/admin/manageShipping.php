...
{
	mysql_query("DELETE FROM shipping_cost WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Manage Shipping</h5>
       	  </div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <tbody>
                <?php
				$getQuery = mysql_query("SELECT * FROM shipping_cost ORDER BY id");
				while($getValue = mysql_fetch_array($getQuery))
				{
				?>
                	<tr>
                        <td colspan="2" align="center"><?php echo '$'.$getValue['fromrange'].'.00 USD'; ?></td>
                      	<td width="25%" align="center"><?php echo '$'.number_format($getValue['torange']).'.00 USD'; ?></td>
                        <td width="25%" align="center"><?php echo '$'.$getValue['shipping_amount'].'.00 USD'; ?></td>
                        <td width="25%" align="center"><a href="manageShipping.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                    <?php
				}
				?>
