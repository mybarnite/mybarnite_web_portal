...
{
	mysql_query("INSERT INTO `admin_login` (`id`, `firstname`, `lastname`, `email`, `username`, `password`, `modaratorid`, `type`, `status`) VALUES ('', '".$_REQUEST['firstname']."', '".$_REQUEST['lastname']."', '".$_REQUEST['email']."', '".$_REQUEST['username']."', '".$_REQUEST['password']."', '".$_REQUEST['group']."', 'M', 'Y')");
	header("location:add-member.php?ret=1");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Add Members</h5></div>
            <?php if(isset($_REQUEST['ret']) == '1') { ?>
            <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Member Added Successfully!</div>
            <?php } ?>
            <div class="rowElem noborder">
            <label>First Name</label>
            <div class="formRight"><input name="firstname" type="text" id="firstname" /></div><div class="fix"></div></div>
            
            <div class="rowElem noborder">
            <label>Last Name</label>
            <div class="formRight"><input name="lastname" type="text" id="lastname" /></div><div class="fix"></div></div>
            
            <div class="rowElem noborder">
            <label>Email</label>
            <div class="formRight"><input name="email" type="text" id="email" /></div><div class="fix"></div></div>
            
            <div class="rowElem noborder">
            <label>Username</label>
            <div class="formRight"><input name="username" type="text" id="username" /></div><div class="fix"></div></div>
            
            <div class="rowElem noborder">
            <label>Password</label>
            <div class="formRight"><input name="password" type="text" id="password" /></div><div class="fix"></div></div>
			...
			<?php 
				...
				{
				?>
              <option value="<?php echo $fetchGroup['id']; ?>"><?php echo $fetchGroup['group_name']; ?></option>
				<?php } ?>
