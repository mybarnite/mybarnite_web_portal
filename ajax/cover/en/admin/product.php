...
if(isset($_REQUEST['submit']) && $_REQUEST['item_name'] != '' && $_REQUEST['to_size'] > $_REQUEST['from_size'])
{
	$_SESSION['seller_details'] = $_REQUEST['seller_details'];
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Add Product - Step 1</h5></div>
            
            <div class="rowElem noborder">
            <label>Seller Profile</label>
            <div class="formRight">
              <select name="seller_details" id="seller_details">
                <option>Select Seller Profile..</option>
                <?php $getSeller = mysql_query("SELECT * FROM `register` WHERE type != 'B'"); 
					  while($getSellerArr = mysql_fetch_array($getSeller)) { ?>
                <option value="<?php echo $getSellerArr['id']; ?>"><?php echo $getSellerArr['id']; ?> - <?php echo $getSellerArr['company_name']; ?></option>
                <?php } ?>
              </select>
            </div></div>
            ...
            <div class="formRight"><input name="item_name" type="text" id="item_name" value="<?php echo $_REQUEST['item_name']; ?>" required /></div></div>
            
            <div class="rowElem noborder">
            <label>From Size</label>
            <div class="formRight"><input name="from_size" type="text" id="from_size" style="width:100px;" value="<?php echo $_REQUEST['from_size']; ?>" required /> Min Size: 1</div></div>
            
            <div class="rowElem noborder">
            <label>To Size</label>
            <div class="formRight"><input name="to_size" type="text" id="to_size" style="width:100px;" value="<?php echo $_REQUEST['to_size']; ?>" required />  Max Size: 20</div></div>
            <br />
...
<div id="footer">
	<div class="wrapper">
    	<span>&copy; Copyright <?php echo date("Y"); ?> Basicfeet.com Basicfeet.com. All rights reserved. </span>
    </div>
</div>
