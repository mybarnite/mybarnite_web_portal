...
{
	mysql_query("UPDATE `home_slider_block` SET banner = '".$_REQUEST['radio']."' WHERE id = '1'");	
	header("location:header_block.php?ret=1"); exit();
}
$getsettings = mysql_fetch_array(mysql_query("SELECT * FROM `home_slider_block` WHERE id = '1'"));
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Home Page Header Blocks</h5></div>
			<?php if(isset($_REQUEST['ret']) == '1') { ?>
            <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Home Page Header Blocks Updated Successfully!</div>
            <?php } ?>
            <div class="rowElem noborder">
            <label>Structure 1</label>
            <div class="formRight">
              <input type="radio" name="radio" value="1" <?php if($getsettings['banner'] == '1') { ?> checked="checked" <?php } ?> /> <br />
              <img src="images/imgblock1.jpg" width="300" height="178" alt="" /> </div></div>
            <div class="rowElem noborder">
            <label>Structure 2</label>
            <div class="formRight">
              <input type="radio" name="radio" value="2" <?php if($getsettings['banner'] == '2') { ?> checked="checked" <?php } ?> /> <br />
              <img src="images/imgblock2.jpg" width="300" height="178" alt="" /> </div></div>
            <div class="rowElem noborder">
            <label>Structure 3</label>
            <div class="formRight">
              <input type="radio" name="radio" value="3" <?php if($getsettings['banner'] == '3') { ?> checked="checked" <?php } ?> /> <br />
              <img src="images/imgblock3.jpg" width="300" height="178" alt="" />
