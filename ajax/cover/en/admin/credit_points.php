...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
       	  <div class="head"><h5 class="iFrames">Credit/Points</h5></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                      <td width="60%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Order ID - Product Names</td>
                        <td width="20%">Amount Credit</td>
                        <td width="20%">Status</td>
                    </tr>
                </thead>
                <tbody>
					<?php $getPage = mysql_query("SELECT DISTINCT date FROM transaction ORDER by datetime DESC");
                        while($getArray = mysql_fetch_array($getPage)) { ?>
                        <tr>
                            <td height="100" colspan="3" align="center" valign="middle"><strong>No Credit/Points Information Found.</strong></td>
                  </tr>
                    <?php } ?>
                </tbody>
            </table>
