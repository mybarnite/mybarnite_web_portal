...
{
	mysql_query("DELETE FROM admin_login WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
    	<div class="title">
    	  <h5>Administrator</h5></div>
        
        <!-- Static table -->
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Manage Member</h5>
       	  </div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td colspan="2" align="left" valign="middle" style="text-align:left; padding-left:8px;">Member Name</td>
                      <td width="16%" align="center" valign="middle">Username</td>
                        <td width="16%" align="center" valign="middle">Password</td>
                        <td width="22%" align="center" valign="middle">Group Name</td>
                        <td width="18%" align="center" valign="middle">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php
				$getQuery = mysql_query("SELECT * FROM admin_login WHERE type = 'M' ORDER BY id DESC");
				while($getValue = mysql_fetch_array($getQuery))
				{
				?>
                	<tr>
                        <td colspan="2" align="left" valign="middle"><?php echo $getValue['firstname'];?> <?php echo $getValue['lastname'];?></td>
                      <td width="16%" align="center" valign="middle"><?php echo $getValue['username'];?></td>
                        <td width="16%" align="center" valign="middle"><?php echo $getValue['password'];?></td>
                        <td width="22%" align="center" valign="middle"><?php $getGroupName = mysql_fetch_array(mysql_query("SELECT * FROM admin_group WHERE id = '".$getValue['modaratorid']."'")); echo $getGroupName['group_name']; ?></td>
                        <td width="18%" align="center" valign="middle"><a href="edit-member.php?eID=<?php echo $getValue['id']; ?>">Edit</a> / <a href="manage-category.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                    <?php
				}
				?>
