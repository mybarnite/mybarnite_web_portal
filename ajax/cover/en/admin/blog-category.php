...

{
	...
	mysql_query("DELETE FROM blog_category WHERE bcat_id = ".$_REQUEST['DelId']);
    ...
    <div class="content">
        ...
        <div class="widget first">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <?php $getQuery = mysql_query("SELECT * FROM blog_category ORDER BY blog_category");

				while($getValue = mysql_fetch_array($getQuery)) { ?>

                	<tr>

                        <td><?php echo $getValue['blog_category'];?></td>

                        <td width="20%" align="center"><a href="add-blog-category.php?id=<?php echo $getValue['bcat_id']; ?>">Edit</a> / <a href="blog-category.php?DelId=<?php echo $getValue['bcat_id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
