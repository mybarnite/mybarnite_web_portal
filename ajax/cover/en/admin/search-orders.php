...
if(isset($_REQUEST['submit1']) && $_REQUEST['orderID'] != '') 
{ 
	header("location:placed-orders.php?order=".$_REQUEST['orderID'].""); 
	exit(); 
}

if(isset($_REQUEST['submit2']) && $_REQUEST['email'] != '') 
{ 
	header("location:order-email.php?email=".$_REQUEST['email'].""); 
	exit(); 
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Search Orders</h5>
       	  </div>
          ...
          <div style="padding:8px;">
            ...
            <table width="42%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="29%"><input type="text" name="orderID" style="padding:6px; font-size:12px; width:150px;" placeholder="Order ID" /></td>
                <td width="24%" align="center"><input name="submit1" type="submit" id="submit1" value="Search Order" /></td>
              </tr>
            </table>
          </form></div>
          ...
          <div style="padding:8px;">
            ...
            <table width="50%" border="0" cellspacing="2" cellpadding="2">
              <tr>
                <td width="36%"><input type="text" name="email" style="padding:6px; font-size:12px; width:200px;" placeholder="Email" /></td>
                <td width="24%" align="center"><input name="submit2" type="submit" id="submit2" value="Search Order" /></td>
              </tr>
            </table>
            </form></div>
      </div>
