...
{
	mysql_query("UPDATE `website_settings` SET `retailor_com` = '".$_REQUEST['retailor_com']."', `manufacturer_com` = '".$_REQUEST['manufacturer_com']."', `distributer_com` = '".$_REQUEST['distributer_com']."', `designer_com` = '".$_REQUEST['designer_com']."' WHERE `id` = '1'");
	header("location:vendor-comission.php");
	exit;
}
?>
      ...
      <form action="" class="mainForm" method="post" name="form1" id="form1">
        ...
        <fieldset>
          <div class="widget first">
            <div class="head">
              <h5 class="iList">Seller / Vendor Comissions</h5>
            </div>
            <div class="rowElem noborder">
              <label>Retailor</label>
              <div class="formRight">
                <input name="retailor_com" type="text" value="<?php echo $dataVal['retailor_com']; ?>" maxlength="2" style="width:80px;" /> %
              </div>
              <div class="fix"></div>
            </div>
            <div class="rowElem">
              ...
              <div class="formRight">
                <input name="manufacturer_com" type="text" value="<?php echo $dataVal['manufacturer_com']; ?>" maxlength="2" style="width:80px;" /> %
              </div>
              <div class="fix"></div>
            </div>
            <div class="rowElem">
              ...
              <div class="formRight">
                <input name="distributer_com" type="text" value="<?php echo $dataVal['distributer_com']; ?>" maxlength="2" style="width:80px;" /> %
              </div>
              <div class="fix"></div>
            </div>
            <div class="rowElem">
              ...
              <div class="formRight">
                <input name="designer_com" type="text" value="<?php echo $dataVal['designer_com']; ?>" maxlength="2" style="width:80px;" /> %
              </div>
              <div class="fix"></div>
            </div>
