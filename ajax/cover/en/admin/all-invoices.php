...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">All Invoice(s)</h5>
       	  </div>
        	<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
        	  <thead>
        	    <tr>
        	      <td width="20%" style="text-align:left; padding-left:8px;">Date</td>
        	      <td width="21%" align="center" valign="middle">Invoice ID#</td>
        	      <td width="39%" align="center" valign="middle">Person Name</td>
        	      <td width="20%" align="center" valign="middle">Action</td>
      	      </tr>
      	    </thead>
        	  <tbody>
        	    <?php //$getQuery = mysql_query("SELECT * FROM `category` ORDER BY category ASC");
					  //while($getValue = mysql_fetch_array($getQuery)) { ?>
        	    <!--<tr>
                        <td><?php echo $getValue['category'];?></td>
                        <td align="center" valign="middle">&nbsp;</td>
                        <td align="center" valign="middle">&nbsp;</td>
                        <td width="20%" align="center" valign="middle"><a href="edit-category.php?eID=<?php echo $getValue['cat_id']; ?>">Edit</a> / <a href="manage-category.php?DelId=<?php echo $getValue['cat_id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>-->
        	    <?php //} ?>
        	    <tr>
        	      <td height="100" colspan="4" align="center" valign="middle">No Invoice Record Found.</td>
      	      </tr>
      	    </tbody>
      	  </table>
        </div>
