...
{
	mysql_query("DELETE FROM saticpages WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Manage Page</h5></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="21%">Page Name</td>
                        <td width="59%">Page Title</td>
                        <td width="20%">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php
				$getPage = mysql_query("SELECT * FROM saticpages");
				while($getArray = mysql_fetch_array($getPage))
				{
				?>
                	<tr>
                        <td width="21%" align="center"><?php echo $getArray['pagename']; ?></td>
                        <td width="59%" align="center"><?php echo $getArray['title']; ?></td>
                        <td width="20%" align="center"><a href="edit-page.php?EditId=<?php echo $getArray['id']; ?>">Edit</a> / <a href="manage-page.php?DelId=<?php echo $getArray['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  </tr>
                  <?php
				}
				  ?>
