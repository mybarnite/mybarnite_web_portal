...
{
	mysql_query("DELETE FROM carousel WHERE id = '".$_REQUEST['DelId']."' ");
	header("location:manageCarousel.php");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
    	<div class="title">
    	  <h5>Manage Carousel</h5></div>
        
        <!-- Static table -->
        <div class="widget first">
        	<div class="head">
        	  <h5 class="iFrames">Manage Carousel</h5>
   	    </div>
        <div style="text-align:right; padding:5px 10px 5px 0;"><a href="addCarousel.php">Add New Carousel</a></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td colspan="2" style="text-align:left; padding-left:8px;">Carousel Thumb</td>
                        <td width="20%" align="center" valign="middle">Carousel URL</td>
                      <td width="20%" align="center" valign="middle">Published On</td>
                        <td width="20%" align="center" valign="middle">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php
				$getQuery = mysql_query("SELECT * FROM carousel ORDER BY carousel_id DESC");
				while($getValue = mysql_fetch_array($getQuery))
				{
				?>
                	<tr>
                        <td colspan="2"><img src="../upload/carousel/<?php echo $getValue['image']; ?>" width="200" height="" border="" alt="" /></td>
                        <td width="20%" align="center" valign="middle"><?php echo $getValue['URL']; ?></td>
                      <td width="20%" align="center" valign="middle"><?php echo $getValue['datetime']; ?></td>
                        <td width="20%" align="center" valign="middle"><a href="addCarousel.php?eID=<?php echo $getValue['carousel_id']; ?>">Edit</a> / <a href="manage-product.php?DelId=<?php echo $getValue['carousel_id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                    <?php
				}
				?>
