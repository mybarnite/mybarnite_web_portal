...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Track Cancellations</h5></div>
          <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
              <thead>
                <tr>
                  <td width="61%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Cancellation Details - Reasons</td>
              ...
              <tbody>
                <tr>
                  <td height="150" colspan="3" align="center" valign="middle">No Order Cancellations Found.</td>
                </tr>
              </tbody>
          </table>
        </div>
