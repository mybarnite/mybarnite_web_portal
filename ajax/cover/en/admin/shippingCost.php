...
if(isset($_REQUEST['submit']) && $_REQUEST['fromrange'] != '')
{
	mysql_query("INSERT INTO `shipping_cost` (`id`, `fromrange`, `torange`, `shipping_amount`, `datetime`, `status`) VALUES ('', '".$_REQUEST['fromrange']."', '".$_REQUEST['torange']."', '".$_REQUEST['shipping_amount']."', now(), 'Y')");
	header("location:shippingCost.php?ret=1");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <!-- Content -->
    <div class="content">
    	<div class="title"><h5>Tools / Extras</h5></div>
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Shipping Cost</h5></div>
            <?php if(isset($_REQUEST['ret']) == '1') { ?>
            <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Shipping Cost Added Successfully!</div>
            <?php } ?>
            <div class="rowElem noborder">
            	<label>From</label>
            	<div class="formRight">$&nbsp;<input name="fromrange" type="text" id="fromrange" style="width:150px;" /></div><div class="fix"></div></div>
            <div class="rowElem noborder">
            	<label>To</label>
            	<div class="formRight">$&nbsp;<input name="torange" type="text" id="torange" style="width:150px;" /></div><div class="fix"></div></div>
            <div class="rowElem noborder">
            	<label>Amount</label>
            	<div class="formRight">$&nbsp;<input name="shipping_amount" type="text" id="shipping_amount" style="width:150px;" /></div><div class="fix"></div></div>
            <br />
            <input type="submit" name="submit" value="Add Shipping Cost" class="greyishBtn submitForm" />
            <div class="fix"></div>
            </div>
            </fieldset>
