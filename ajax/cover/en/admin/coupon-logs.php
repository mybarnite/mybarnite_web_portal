...
{
	mysql_query("DELETE FROM `coupons` WHERE id = '".$_REQUEST['DelId']."' ");
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Coupon Logs</h5></div>
        
      	<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="33%" align="left" valign="middle" style="padding-left:8px; text-align:left;">Customer Name</td>
                        <td width="17%" align="center" valign="middle">Order ID</td>
                        <td width="17%" align="center" valign="middle">Coupon Applied</td>
                        <td width="20%" align="center" valign="middle">Order Placed</td>
                        <td width="13%">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php $getQuery = mysql_query("SELECT * FROM `coupons` ORDER BY id DESC");
					  while($getValue = mysql_fetch_array($getQuery)) { ?>
                	<!--<tr>
                        <td width="41%"><?php echo $getValue['offer']; ?></td>
                        <td width="15%" align="center" valign="middle"><?php echo $getValue['promo']; ?></td>
                        <td width="15%" align="center" valign="middle"><?php echo $getValue['discount'].'%'; ?></td>
                        <td width="30%" align="center" valign="middle"><?php echo $getValue['expiry']; ?></td>
                        <td width="13%" align="center"><a href="add-coupons.php?eID=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to edit the promo offer?')">Edit</a>&nbsp;&nbsp;<span style="color:#CCC;">|</span>&nbsp;&nbsp;<a href="manage-coupons.php?DelId=<?php echo $getValue['id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>-->
                    <?php } ?>
                    <tr>
                        <td height="100" colspan="5" align="center" valign="middle">No logs available.</td>
                    </tr>
                </tbody>
            </table>
        </div>
