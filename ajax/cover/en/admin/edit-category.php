...
{
	$Insert = mysql_query("UPDATE `category` SET catname = '".mysql_real_escape_string($_REQUEST['catname'])."' WHERE id = '".$_REQUEST['eID']."'");
	header("location:edit-category.php?eID=".$_REQUEST['eID']."");
	exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head"><h5 class="iList">Edit Category</h5></div>
            <div class="rowElem noborder">
            <?php $getCat = mysql_fetch_array(mysql_query("SELECT * FROM category where id = '".$_REQUEST['eID']."'")); ?>
            <label>Category</label>
            <div class="formRight"><input name="catname" type="text" id="catname" value="<?php echo $getCat['catname']; ?>" /></div><div class="fix"></div></div>
            <br />
