    ...
    <div style="padding:6px 0 0 0;">
      <form id="form1" name="form1" method="post" action="">
        <table width="77%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="12%" align="left" valign="middle">Begin date:</td>
        ...
        <div class="widget first">
       	  <div class="head"><h5 class="iFrames">Customer Report</h5></div>
          <?php
		  if(isset($_REQUEST['datepick']) != '')
			{
			$getPage = mysql_query("SELECT * FROM register WHERE date >= '".$_REQUEST['datepick']."' AND date <= '".$_REQUEST['datepick2']."'");
			}
			else
			{
			$getPage = mysql_query("SELECT * FROM register WHERE date >= '".date("d M, Y")."' AND date <= '".date("d M, Y")."'");	
			}
		  ?>
          <div style="padding:8px;">Total customer accounts: <strong><?php echo mysql_num_rows($getPage); ?></strong></div>
          
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="50%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Username</td>
                        <td width="25%">Joined Date</td>
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                      <td width="50%" align="left" valign="middle"><?php echo $getArray['username']; ?></td>
                        <td width="25%" align="center"><?php echo $getArray['date']; ?></td>
                        <td width="25%" align="center"><?php echo $getArray['status']; ?></td>
                    </tr>
                <?php
                	}
                ?>
