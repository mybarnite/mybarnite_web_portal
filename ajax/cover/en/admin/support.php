...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Contacts / Support</h5></div>
            <?php if(isset($_REQUEST['view']) != '') { 
				$getSupport = mysql_fetch_array(mysql_query("SELECT * FROM contacts WHERE support_id = '".$_REQUEST['view']."'"));
				$updateStatus = mysql_query("UPDATE contacts SET status = 'Y' WHERE support_id = '".$_REQUEST['view']."'");
			?>
          <form id="form1" name="form1" method="post" action="support.php">
          <div style="padding:13px;">
          	<table width="70%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="26%" height="36" align="left" valign="middle">First Name:</td>
                <td width="74%" height="36" align="left" valign="middle"><?php echo $getSupport['firstname']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">Last Name:</td>
                <td height="36" align="left" valign="middle"><?php echo $getSupport['lastname']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">Email:</td>
                <td height="36" align="left" valign="middle"><?php echo $getSupport['email']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">Subject:</td>
                <td height="36" align="left" valign="middle"><?php echo $getSupport['subject']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">Message:</td>
                <td height="36" align="left" valign="middle"><?php echo $getSupport['message']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">Date / Time:</td>
                <td height="36" align="left" valign="middle"><?php echo $getSupport['date']; ?> - <?php echo $getSupport['time']; ?></td>
              </tr>
              <tr>
                <td height="36" align="left" valign="middle">&nbsp;</td>
                <td height="36" align="left" valign="middle">
                <a href="sendEmail.php?email=<?php echo $getSupport['email']; ?>">
                <img src="images/replyBtn.jpg" width="63" height="27" alt="" /></a>&nbsp;&nbsp;<a href="support.php"><img src="images/backBtn.jpg" width="58" height="27" alt="" /></a></td>
              </tr>
            </table>
          </div>
          </form>
<?php } else {?>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
            	<thead>
                	<tr>
                        <td width="61%" align="left" valign="middle" style="text-align:left; padding-left:8px;">Subject</td>
                      <td width="21%">Date / Time</td>
                      <td width="18%">Action</td>
                    </tr>
                </thead>
                <tbody>
                <?php
				$getPage = mysql_query("SELECT * FROM contacts ORDER BY datetime DESC");
				while($getArray = mysql_fetch_array($getPage))
				{
				?>
                	<tr>
                      <td width="61%" align="left" valign="middle" <?php if($getArray['status'] == 'N') { ?> style="font-weight:bold;" <?php } ?>><?php echo $getArray['subject']; ?></td>
                      <td width="21%" align="center"><?php echo $getArray['date']; ?> <?php echo $getArray['time']; ?></td>
                      <td width="18%" align="center"><a href="support.php?view=<?php echo $getArray['support_id']; ?>">View</a> / <a href="manage-page.php?DelId=<?php echo $getArray['support_id']; ?>" onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                  </tr>
                  <?php
				}
				  ?>
