...
{
	mysql_query("INSERT INTO `subcat` (`id`, `catid`, `subcat`, `status`) VALUES ('', '".mysql_real_escape_string($_REQUEST['category'])."', '".$_REQUEST['cityname']."', 'Y')"); header("location:manage-sub-category.php?ret=1"); exit;
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
        ...
        <form action="" class="mainForm" method="post" name="form1" id="form1">
            ...
            <div class="head">
                <h5 class="iList">Add Sub Category</h5></div>
				<?php if(isset($_REQUEST['ret']) == '1') { ?>
                <div style="color:#090; font-weight:bold; padding:5px 0 5px 13px;">Catagory Added Successfully!</div>
                <?php } ?>
                ...
                <div class="formRight"><input name="cityname" type="text" id="cityname" /></div><div class="fix"></div></div>
                <br />
