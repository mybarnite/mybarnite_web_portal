...
{
	header("location:export-cust.php");
	exit();
}
?>
...
<div class="wrapper">
    ...
    <div class="content">
    	<div class="title">
    	  <h5>Export Data</h5></div>
        
        <!-- Static table -->
        <div class="widget first">
        	<div class="head"><h5 class="iFrames">Export Products</h5></div>
          <div style="font-weight:bold; padding:10px 10px 10px 10px;">Export and Save Product Data onto your Local Machine</div>
            <div style="font-weight:bold; padding:2px 10px 10px 10px;">All product records will be exported as an Excel (.xls) file.</div>
